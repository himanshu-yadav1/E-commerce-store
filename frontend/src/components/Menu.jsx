    ...
    return (
        <>
            ...
            {hoveredLink === 'electronics' &&
                <div onMouseEnter={() => handleMouseEnter('electronics')} onMouseLeave={handleMouseLeave} className='hidden sm:flex absolute left-[23vw] py-3 px-5 border border-b-2 rounded-xl shadow-md border-gray-300 duration-150 animate-in slide-in-from-bottom-8'>
            ...
            {hoveredLink === 'men' &&
                <div onMouseEnter={() => handleMouseEnter('men')} onMouseLeave={handleMouseLeave} className='hidden sm:flex absolute left-[35vw] py-3 px-5 border border-b-2 rounded-xl shadow-md border-gray-300 duration-150 animate-in slide-in-from-bottom-8'>
                    <div className='flex font-thin gap-8'>
                        <div className='flex flex-col gap-1'>
            ...
            {hoveredLink === 'women' &&
                <div onMouseEnter={() => handleMouseEnter('women')} onMouseLeave={handleMouseLeave} className='hidden sm:flex absolute left-[43vw] py-3 px-5 border border-b-2 rounded-xl shadow-md border-gray-300 duration-150 animate-in slide-in-from-bottom-8'>
                    <div className='flex font-thin gap-8'>
                        <div className='flex flex-col gap-1'>
                            <Link to={'/'} className='hover:text-[#D65DB1]'>Formal</Link>
                            <Link to={'/'} className='hover:text-[#D65DB1]'>Casual</Link>
            ...
            {hoveredLink === 'fitness' &&
                <div onMouseEnter={() => handleMouseEnter('fitness')} onMouseLeave={handleMouseLeave} className='hidden sm:flex absolute left-[52vw] py-3 px-5 border border-b-2 rounded-xl shadow-md border-gray-300 duration-150 animate-in slide-in-from-bottom-8'>
                    <div className='flex font-thin gap-8'>
                        <div className='flex flex-col gap-1'>
