...
function ProductItem({ product }) {
    return (
        <div className="z-0 relative flex-grow w-[200px] max-w-[230px] bg-white px-3 py-2 shadow-sm rounded-xl border">
            ...
            <Link>
                <img
                    src={product.image}
                    alt={product.name}
                    className="w-full h-44 object-cover mb-3 rounded-lg"
