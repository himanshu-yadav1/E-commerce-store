...
function ProductItem2({ product }) {
    return (
        <>
            <Link
                className="flex flex-grow w-[250px] max-w-[310px] items-center gap-5 px-3 py-2 bg-white rounded-xl border border-gray-200 transition-all duration-75 shadow-sm hover:shadow-md"
